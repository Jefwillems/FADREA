    ...
    return function a(b, c, d) {
        ...
        9: [function (b, c, d) {
            (function (e) {
                !function (b, e) {
                    ...
                    function W(a) {
                        var b = new Ke.Table("cmap", [{name: "version", type: "USHORT", value: 0}, {
                            name: "numTables",
                            type: "USHORT",
                            value: 1
                    ...
                    function ga(a, b) {
                        if (b.isComposite) for (var c = 0; c < b.components.length; c += 1) {
                            ...
                            if (e.getPath(), e.points) {
                                var f = void 0;
                                if (void 0 === d.matchedPoints) f = da(e.points, d); else {
                    ...
                    function pa(a, b) {
                        ...
                        if (Array.isArray(a) && Array.isArray(b)) {
                            ...
                            for (var c = 0; c < a.length; c += 1) if (!pa(a[c], b[c])) return !1;
                            return !0
                        }
                        return !1
                    }
                    ...
                    function Ca(a, b, c, d) {
                        ...
                        if (0 === i) for (var j = 0; j < c; j += 1) e = g.parseSID(), h.push(wa(d, e)); else if (1 === i) for (; h.length <= c;) {
                    ...
                    function Ga(a, b, c) {
                        c.tables.cff = {};
                        var d = ya(a, b), e = ra(a, d.endOffset, Ne.bytesToString), f = ra(a, e.endOffset),
                            g = ra(a, f.endOffset, Ne.bytesToString), h = ra(a, g.endOffset);
                        ...
                        var o = b + j.private[1], p = Aa(a, o, j.private[0], g.objects);
                    ...
                    function Ia() {
                        return new Ke.Record("Header", [{name: "major", type: "Card8", value: 1}, {
                            name: "minor",
                            type: "Card8",
                            value: 0
                    ...
                    function La(a, b) {
                        var c = new Ke.Record("Top DICT", [{name: "dict", type: "DICT", value: {}}]);
                        return c.dict = Ka(We, a, b), c
                    }

                    function Ma(a) {
                        var b = new Ke.Record("Top DICT INDEX", [{name: "topDicts", type: "INDEX", value: []}]);
                    ...
                    function Sa(a, b) {
                        var c = new Ke.Record("Private DICT", [{name: "dict", type: "DICT", value: {}}]);
                        return c.dict = Ka(Xe, a, b), c
                    }

                    function Ta(a, b) {
                        for (var c, d = new Ke.Table("CFF ", [{name: "header", type: "RECORD"}, {
                            name: "nameIndex",
                            type: "RECORD"
                    ...
                    function Xa(a) {
                        return new Ke.Table("hhea", [{name: "version", type: "FIXED", value: 65536}, {
                            name: "ascender",
                            type: "FWORD",
                            value: 0
                    ...
                    function $a(a) {
                        for (var b = new Ke.Table("ltag", [{name: "version", type: "ULONG", value: 1}, {
                            name: "flags",
                            type: "ULONG",
                            value: 0
                        }, {
                    ...
                    function _a(a, b) {
                        var c = new Ne.Parser(a, b), d = c.parseULong();
                    ...
                    function bb(a) {
                        return new Ke.Table("maxp", [{name: "version", type: "FIXED", value: 20480}, {
                            name: "numGlyphs",
                            type: "USHORT",
                            value: a
                        }])
                    ...
                    function eb(a, b, c) {
                        for (var d = {}, e = new Ne.Parser(a, b), f = e.parseUShort(), g = e.parseUShort(), h = e.offset + e.parseUShort(), i = 0; i < g; i++) {
                            var j = e.parseUShort(), k = e.parseUShort(), l = e.parseUShort(), m = e.parseUShort(),
                                n = cf[m] || m, o = e.parseUShort(), p = e.parseUShort(), q = cb(j, l, c),
                                r = db(j, k, l);
                    ...
                    function jb(a, b) {
                        ...
                        for (var z = new Ke.Table("name", [{name: "format", type: "USHORT", value: 0}, {
                            name: "count",
                            type: "USHORT",
                            value: k.length
                        }, {
                    ...
                    function nb(a, b) {
                        ...
                        switch (c.version = d.parseVersion(), c.italicAngle = d.parseFixed(), c.underlinePosition = d.parseShort(), c.underlineThickness = d.parseShort(), c.isFixedPitch = d.parseULong(), c.minMemType42 = d.parseULong(), c.maxMemType42 = d.parseULong(), c.minMemType1 = d.parseULong(), c.maxMemType1 = d.parseULong(), c.version) {
                            ...
                            case 2:
                                ...
                                c.names = [];
                                for (var f = 0; f < c.numberOfGlyphs; f++) if (c.glyphNameIndex[f] >= Se.length) {
                                    var g = d.parseChar();
                    ...
                    function pb(a, b) {
                        b = b || 0;
                        var c = new Q(a, b), d = c.parseVersion();
                    ...
                    function qb(a) {
                        return new Ke.Table("GSUB", [{name: "version", type: "ULONG", value: 65536}, {
                            name: "scripts",
                            type: "TABLE",
                            value: new Ke.ScriptList(a.scripts)
                        }, {name: "features", type: "TABLE", value: new Ke.FeatureList(a.features)}, {
                            name: "lookups",
                            type: "TABLE",
                    ...
                    function sb(a) {
                        var b = Object.keys(a).length, c = "", d = 16 + 12 * b,
                            e = new Ke.Table("meta", [{name: "version", type: "ULONG", value: 1}, {
                                name: "flags",
                                type: "ULONG",
                                value: 0
                    ...
                    function wb(a) {
                        var b = new Ke.Table("sfnt", [{name: "version", type: "TAG", value: "OTTO"}, {
                            name: "numTables",
                            type: "USHORT",
                            value: 0
                    ...
                    function zb(a) {
                        ...
                        var u = Ze.make({
                            ...
                            }), w = bf.make(a.glyphs.length), x = mf.make({
                                ...
                                ulCodePageRange1: 1,
                                sxHeight: xb(a, "xyvw", {yMax: Math.round(t.ascender / 2)}).yMax,
                                sCapHeight: xb(a, "HIKLEFJMNTZBDPRAGOQSUVWXY", t).yMax,
                                usDefaultChar: a.hasChar(" ") ? 32 : 0,
                                usBreakChar: a.hasChar(" ") ? 32 : 0
                            }), y = _e.make(a.glyphs), z = Oe.make(a.glyphs), A = a.getEnglishName("fontFamily"),
                        ...
                        var G = [], H = kf.make(E, G), I = G.length > 0 ? af.make(G) : void 0, J = nf.make(),
                            K = Ye.make(a.glyphs, {
                        ...
                        for (var N = wb(M), O = N.encode(), P = ub(O), Q = N.fields, R = !1, S = 0; S < Q.length; S += 1) if ("head table" === Q[S].name) {
                    ...
                    function Vd(a, b, c) {
                        var d = new Ne.Parser(a, b), e = d.parseULong();
                    ...
                    function Wd(a, b) {
                        for (var c = new Ne.Parser(a, b), d = c.parseUShort(), e = [], f = 0; f < d; f++) e[c.parseTag()] = {offset: c.parseUShort()};
                        return e
                    }

                    function Xd(a, b) {
                        var c = new Ne.Parser(a, b), d = c.parseUShort(), e = c.parseUShort();
                    ...
                    function Yd(a, b) {
                        var c = new Ne.Parser(a, b), d = c.parseUShort();
                        if (1 === d) {
                    ...
                    function Zd(a, b) {
                        var c, d = new Ne.Parser(a, b), e = d.parseUShort(), f = d.parseUShort(), g = Xd(a, b + f),
                            h = d.parseUShort(), i = d.parseUShort();
                        if (4 === h && 0 === i) {
                            var j = {};
                            if (1 === e) {
                            ...
                            if (2 === e) {
                                for (var s = d.parseUShort(), t = d.parseUShort(), u = d.parseUShort(), v = d.parseUShort(), w = Yd(a, b + s), x = Yd(a, b + t), y = [], z = 0; z < u; z++) for (var A = y[z] = [], B = 0; B < v; B++) h && (c = d.parseShort()), i && d.parseShort(), A[B] = c;
                    ...
                    function $d(a, b) {
                        var c = new Ne.Parser(a, b), d = c.parseUShort(), e = c.parseUShort(), f = 16 & e,
                            g = c.parseUShort(), h = c.parseOffset16List(g),
                    ...
                    function _d(a, b, c) {
                        var d = new Ne.Parser(a, b), e = d.parseFixed();
                    ...
                    function ge(a, b) {
                        for (var c = [], d = 12, e = 0; e < b; e += 1) {
                            var f = Ne.getTag(a, d), g = Ne.getULong(a, d + 4), h = Ne.getULong(a, d + 8),
                    ...
                    function je(a) {
                        var b, c, d, e = new Od({empty: !0}), f = new DataView(a, 0), g = [], h = Ne.getTag(f, 0);
                        if (h === String.fromCharCode(0, 1, 0, 0) || "true" === h || "typ1" === h) e.outlinesFormat = "truetype", d = Ne.getUShort(f, 4), g = ge(f, d); else if ("OTTO" === h) e.outlinesFormat = "cff", d = Ne.getUShort(f, 4), g = ge(f, d); else {
                    ...
                    var me = 0, ne = -3, oe = new c, pe = new c, qe = new Uint8Array(30), re = new Uint16Array(30),
                        se = new Uint8Array(30), te = new Uint16Array(30),
                        ue = new Uint8Array([16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15]),
                        ve = new c, we = new Uint8Array(320), xe = new Uint16Array(16);
                    ...
                    De.MACSTRING = function (a, b) {
                        ...
                        var c = [];
                        if (Array.isArray(b)) for (var d = 0; d < b.length; d += 1) ze.argument(a.length === b.length, "Not enough arguments given for type" + b), c = c.concat(De.OPERAND(a[d], b[d])); else if ("SID" === b) c = c.concat(De.NUMBER(a)); else if ("offset" === b) c = c.concat(De.NUMBER32(a)); else if ("number" === b) c = c.concat(De.NUMBER(a)); else {
                    ...
                    Q.prototype.parseScriptList = function () {
                        return this.parsePointer(Q.recordList({
                            ...
                            script: Q.pointer({
                                ...
                                langSysRecords: Q.recordList({tag: Q.tag, langSys: Q.pointer(Me)})
                            })
                        }))
                    ...
                    ja.prototype.bindConstructorValues = function (a) {
                        ...
                        if (d.hinting && e && e.hinting && (g = this.path && e.hinting.exec(this, c)), g) f = Ue.getPath(g).commands, a = Math.round(a), b = Math.round(b), h = i = 1; else {
                    ...
                    var Ve = {GlyphSet: la, glyphLoader: ma, ttfGlyphLoader: na, cffGlyphLoader: oa},
                        ...
                        Xe = [{name: "subrs", op: 19, type: "offset", value: 0}, {
                            name: "defaultWidthX",
                            op: 20,
                            type: "number",
                            value: 0
                        }, {name: "nominalWidthX", op: 21, type: "number", value: 0}], Ye = {parse: Ga, make: Ta},
                        Ze = {parse: Ua, make: Va}, $e = {parse: Wa, make: Xa}, _e = {parse: Ya, make: Za},
                        af = {make: $a, parse: _a}, bf = {parse: ab, make: bb},
                        ...
                        lf = [{begin: 0, end: 127}, {begin: 128, end: 255}, {begin: 256, end: 383}, {
                            begin: 384,
                            end: 591
                        ...
                        mf = {parse: lb, make: mb, unicodeRanges: lf, getUnicodeRange: kb}, nf = {parse: nb, make: ob},
                        of = new Array(9);
                    of[1] = function () {
                        var a = this.offset + this.relativeOffset, b = this.parseUShort();
                        return 1 === b ? {
                    ...
                    qf[1] = function (a) {
                        return 1 === a.substFormat ? new Ke.Table("substitutionTable", [{
                            ...
                            type: "USHORT",
                            value: 1
                        }, {name: "coverage", type: "TABLE", value: new Ke.Coverage(a.coverage)}, {
                            name: "deltaGlyphID",
                            type: "USHORT",
                    ...
                    var rf = {parse: pb, make: qb}, sf = {parse: rb, make: sb},
                        tf = {make: wb, fontToTable: zb, computeCheckSum: ub};
                    Cb.prototype = {
                        searchTag: Ab, binSearch: Bb, getTable: function (a) {
                        ...
                        if (j >= 0) {
                            for (var k = f.ligatureSets[j], l = 0; l < k.length; l++) if (Eb(k[l].components, h)) return;
                            k.push(i)
                    ...
                    Kb.prototype.exec = function (b, c) {
                        ...
                        if (b.features) {
                            ...
                            for (var j = 0; j < g; j += 1) for (var k = 0; k < i.length; k++) {
        ...
        15: [function (a, b, c) {
            ...
            d.Color._parseInputs = function (a, b, c, h) {
                var i = arguments.length, j = this.mode, k = this.maxes, m = [];
        ...
        29: [function (a, b, c) {
            ...
            d.Renderer2D = function (a, b, c) {
                ...
                var d = this._getStroke(), e = this._getFill();
        ...
        32: [function (a, b, c) {
            ...
            function d(a, b) {
                for (var c = 1; c < arguments.length; c++) {
                    var d = arguments[c];
                    if (null != d) for (var e in d) d.hasOwnProperty(e) && (a[e] = d[e])
                }
            }
        ...
        45: [function (a, b, c) {
            ...
            a("../core/error_helpers"), h.prototype.loadJSON = function () {
                ...
                var b, c, e = [], f = !1, g = a.substring(a.lastIndexOf(".") + 1, a.length), i = ",", j = !1;
                "tsv" === g && (i = "\t");
                ...
                if (2 == arguments.length - f && "string" == typeof arguments[0] && "object" == typeof arguments[1]) c = new Request(arguments[0], arguments[1]), a = arguments[2], b = arguments[3], "" === d && (d = -1 !== c.url.indexOf("json") ? "json" : -1 !== c.url.indexOf("xml") ? "xml" : "text"); else {
                    for (var j, k = arguments[0], l = "GET", m = 1; m < arguments.length; m++) {
                        var n = arguments[m];
                        if ("string" == typeof n) "GET" === n || "POST" === n || "PUT" === n || "DELETE" === n ? l = n : "json" === n || "jsonp" === n || "xml" === n || "text" === n ? d = n : j = n; else if ("number" == typeof n) j = n.toString(); else if ("object" == typeof n) if (n.hasOwnProperty("jsonpCallback")) for (var o in n) e[o] = n[o]; else j = JSON.stringify(n), g = "application/json"; else "function" == typeof n && (a ? b = n : a = n)
                    }
        ...
        52: [function (a, b, c) {
            ...
            d.Vector = function () {
                ...
                var g = Math.cos(b), h = Math.sin(b), i = Math.cos(a), j = Math.sin(a);
                ...
                var c = Math.sqrt(1 - b * b), e = c * Math.cos(a), g = c * Math.sin(a);
        ...
        58: [function (a, b, c) {
            ...
            function p(a, b) {
                var c, d = o(a), e = b && o(b), f = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null},
        ...
        65: [function (a, b, c) {
            ...
            d.prototype.ambientLight = function (a, b, c, d) {
                ...
                var g, h, i, j = this._renderer._useLightShader(), k = this.color.apply(this, [a, b, c]),
        ...
        68: [function (a, b, c) {
            ...
            d.Geometry = function (a, b, c) {
                ...
                for (var a = [], b = 0; b < this.vertices.length; b++) {
                    for (var c = new d.Vector, e = 0; e < this.faces.length; e++) if (this.faces[e][0] === b || this.faces[e][1] === b || this.faces[e][2] === b) {
                ...
                if (Array.isArray(this.strokeIndices)) for (var a = 0, b = this.strokeIndices.length; a < b; a++) this.edges.push(this.strokeIndices[a]); else for (var c = 0; c < this.faces.length; c++) this.edges.push([this.faces[c][0], this.faces[c][1]]), this.edges.push([this.faces[c][1], this.faces[c][2]]), this.edges.push([this.faces[c][2], this.faces[c][0]]);
                return this
            }, d.RendererGL.prototype._edgesToVertices = function (a) {
                a.lineVertices = [];
                for (var b = 0; b < a.edges.length; b++) {
                    var c = a.vertices[a.edges[b][0]], d = a.vertices[a.edges[b][1]], e = d.copy().sub(c).normalize(),
                        f = c.array(), g = c.array(), h = d.array(), i = d.array(), j = e.array(), k = e.array();
        ...
        69: [function (a, b, c) {
            "use strict";
            var d = a("../core/core"), e = a("../math/polargeometry"), f = a("../core/constants"), g = Array,
                h = function (a) {
            ...
            "undefined" != typeof Float32Array && (g = Float32Array, h = function (a) {
                ...
                var t = b * i - c * g, u = b * j - e * g, v = b * k - f * g, w = c * j - e * i, x = c * k - f * i,
                ...
                var c = this.mat4[0], e = this.mat4[1], f = this.mat4[2], g = this.mat4[3];
                ...
                var j = this.mat4[0], k = this.mat4[1], l = this.mat4[2], m = this.mat4[3], n = this.mat4[4],
                    o = this.mat4[5], p = this.mat4[6], q = this.mat4[7], r = this.mat4[8], s = this.mat4[9],
                    t = this.mat4[10], u = this.mat4[11], v = Math.sin(h), w = Math.cos(h), x = 1 - w,
                    y = b * b * x + w, z = c * b * x + g * v, A = g * b * x - c * v, B = b * c * x - g * v,
                    C = c * c * x + w, D = g * c * x + b * v, E = b * g * x + c * v, F = c * g * x - b * v,
                    G = g * g * x + w;
        ...
        75: [function (a, b, c) {
            ...
            d.prototype.cylinder = function (a, b, c, f) {
                ...
                if (void 0 === a) a = 50; else if (!a) return;
                ...
                var b = a[0], c = a[1], e = a[2], f = a[3], g = a[4] || 24, h = a[5] || 16, i = "rect|" + g + "|" + h;
                if (!this.geometryInHash(i)) {
                    var j = function () {
...
!function (a, b) {
    ...
    a.prototype.select = function (c, d) {
        ...
        b || (b = {video: e, audio: f}), navigator.mediaDevices.getUserMedia(b).then(function (a) {
            try {
...
!function (t, e) {
    ...
    e = function () {
        ...
        if (u) {
            var c = !1, p = function () {
                if (!c) {
                    var t = e.createBuffer(1, 1, 22050), i = e.createBufferSource();
    ...
    i = function () {
        ...
        return t.prototype.getMasterVolume = function () {
            ...
            if ("number" == typeof t) {
                var e = e || 0, n = n || 0, o = i.audiocontext.currentTime, r = i.output.gain.value;
    ...
    n = function () {
        ...
        return t.prototype.sampleRate = function () {
            ...
            if ("string" == typeof i) {
                n = i;
                var o = n.split(".").pop();
                if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(o) > -1) if (t.prototype.isFileSupported(o)) n = n; else for (var r = n.split("."), s = r[r.length - 1], a = 0; a < e.extensions.length; a++) {
                    var u = e.extensions[a], c = t.prototype.isFileSupported(u);
                    if (c) {
                        s = "", 2 === r.length && (s += r[0]);
                ...
                } else for (var a = 0; a < e.extensions.length; a++) {
                    var u = e.extensions[a], c = t.prototype.isFileSupported(u);
                    if (c) {
                        n = n + "." + u;
                        break
            ...
            } else if ("object" == typeof i) for (var a = 0; a < i.length; a++) {
                var u = i[a].split(".").pop(), c = t.prototype.isFileSupported(u);
                if (c) {
                    n = i[a];
                    break
                }
    ...
    r = function () {
        ...
        "undefined" != typeof n.createStereoPanner ? (t.Panner = function (t, e) {
            ...
            var i = e || 0, o = n.currentTime + i, r = (t + 1) / 2, s = Math.cos(r * Math.PI / 2),
    ...
    s = function () {
        ...
        var c = o, p = i, h = p.audiocontext, l = n.midiToFreq;
        t.SoundFile = function (e, i, n, o) {
            ...
            var e = p.audiocontext.currentTime, i = t || 0, n = i + e;
            ...
            if ("sustain" === this.mode || "untildone" === this.mode) this.stopAll(e), this._playing = !1, this.pauseTime = 0, this._paused = !1; else if (this.buffer && this.bufferSourceNode) {
                var i = p.audiocontext.currentTime, n = e || 0;
            ...
            var e = p.audiocontext.currentTime, i = t || 0;
            ...
            if ("number" == typeof t) {
                var n = e || 0, o = i || 0, r = p.audiocontext.currentTime, s = this.output.gain.value;
            ...
            var t = this._lastPos / h.sampleRate, e = this.getVolume();
            ...
            var e = t.length, i = t[0].length, n = h.createBuffer(e, i, h.sampleRate);
        ...
        var f = function (t) {
            const e = t.length, i = h.createBuffer(1, t.length, h.sampleRate), n = i.getChannelData(0);
            for (var o = 0; e > o; o++) n[o] = o;
            return i
        };
        t.SoundFile.prototype._initCounterNode = function () {
            var e = this, i = h.currentTime, n = h.createBufferSource();
            ...
            var u = this.buffer.length, c = this.buffer.sampleRate, p = this.buffer, h = [], l = i || .9, f = l,
                d = n || .22, m = o || 200, y = new window.OfflineAudioContext(1, u, c), v = y.createBufferSource();
            v.buffer = p;
            ...
            g.type = "lowpass", v.connect(g), g.connect(y.destination), v.start(0), y.startRendering(), y.oncomplete = function (i) {
                var n = i.renderedBuffer, o = n.getChannelData(0);
                do h = e(o, f), f -= .005; while (Object.keys(h).length < m && f >= d);
                var u = r(h), c = s(u, n.sampleRate), p = c.sort(function (t, e) {
                    return e.count - t.count
                }).splice(0, 5);
                this.tempo = p[0].tempo;
                var l = 5, y = a(h, p[0].tempo, n.sampleRate, l);
                t(y)
            }
        };
        var d = function (t, e) {
        ...
        t.SoundFile.prototype.addCue = function (t, e, i) {
            var n = this._cueIDCounter++, o = new m(e, t, n, i);
    ...
    P = function () {
        ...
        t.Oscillator.prototype.add = function (t) {
            ...
            var e = new o(t), i = this.mathOps.length - 1, n = this.output;
            ...
            var c = new r(a, u), p = this.mathOps.length - 1, h = this.output;
    ...
    F = function () {
        ...
        a.setContext(e.audiocontext), t.Env = function (t, i, n, o, r, a) {
            ...
            var i = new o(e), n = this.mathOps.length, r = this.output;
            return t.prototype._mathChain(this, i, n, r, o)
        }, t.Env.prototype.scale = function (e, i, n, o) {
            var s = new r(e, i, n, o), a = this.mathOps.length, u = this.output;
    ...
    q = function () {
        ...
        t.Pulse = function (i, o) {
            ...
            var o = n.audiocontext.currentTime, r = i || 0;
            if (!this.started) {
            ...
            if (this.started) {
                var e = t || 0, i = n.audiocontext.currentTime;
            ...
            function i(e) {
                for (var i in t.Expr._Expressions) {
                    ...
                    for (var o in n) {
                        ...
                        if (null !== a) return {
                            type: i, value: a[0], method: r.method
                        }
                    }
                }
    ...
    $ = function () {
        ...
        t.Reverb = function () {
            ...
            if ("number" == typeof t && t < this.impulses.length && (this.convolverNode.buffer = this.impulses[t].audioBuffer), "string" == typeof t) for (var e = 0; e < this.impulses.length; e++) if (this.impulses[e].name === t) {
    ...
    tt = function () {
        var e = i, n = K;
        t.Metro = function () {
            this.clock = new n({callback: this.ontick.bind(this)}), this.syncedParts = [], this.bpm = 120, this._init(), this.prevTick = 0, this.tatumTime = 0, this.tickCallback = function () {
            }
    ...
    ot = function () {
        ...
        var o = i, r = o.audiocontext;
        t.SoundRecorder = function () {
            this.input = r.createGain(), this.output = r.createGain(), this.recording = !1, this.bufferSize = 1024, this._channels = 2, this._clear(), this._jsNode = r.createScriptProcessor(this.bufferSize, this._channels, 2), this._jsNode.onaudioprocess = this._audioprocess.bind(this), this._callback = function () {
            }, this._jsNode.connect(t.soundOut._silentNode), this.setInput(), o.soundArray.push(this)
            ...
            o.soundArray.splice(t, 1), this._callback = function () {
    ...
    at = function () {
        ...
        return t.AudioVoice = function () {
            ...
            var i = {A: 21, B: 23, C: 24, D: 26, E: 28, F: 29, G: 31}, n = i[e[0]],
    ...
    ut = function () {
        ...
        t.MonoSynth = function () {
            ...
            var i = i || 0, n = "string" == typeof t ? this._setNote(t) : "number" == typeof t ? t : 440, o = e || 1;
    ...
    ct = function () {
        ...
        t.PolySynth = function (i, o) {
            ...
            var s, a = e.audiocontext.currentTime, u = r || 0, c = a + u,
                p = "string" == typeof i ? this.AudioVoice.prototype._setNote(i) : "number" == typeof i ? i : 440,
                h = void 0 === o ? 1 : o;
            if (void 0 !== this.notes[p] && null !== this.notes[p].getValueAtTime(c) && this.noteRelease(p, 0), this._voicesInUse.getValueAtTime(c) < this.polyValue) s = this._voicesInUse.getValueAtTime(c); else {
                s = this._oldest;
            ...
            var n = "string" == typeof t ? this.AudioVoice.prototype._setNote(t) : "number" == typeof t ? t : this.audiovoices[this._newest].oscillator.freq().value,
                o = e.audiocontext.currentTime, r = i || 0, s = o + r;
            if (null === this.notes[n].getValueAtTime(s)) console.warn("Cannot release a note that is not already playing"); else {
...
console.log("### p5.collide ###"), p5.prototype._collideDebug = !1, p5.prototype.collideDebug = function (a) {
    ...
    var h = this.dist(a, b, c, d), i = this.dist(a, b, e, f), j = this.dist(c, d, e, f);
    return void 0 === g && (g = .1), h + i >= j - g && j + g >= h + i ? !0 : !1
}, p5.prototype.collideLineCircle = function (a, b, c, d, e, f, g) {
    var h = this.collidePointCircle(a, b, e, f, g), i = this.collidePointCircle(c, d, e, f, g);
    if (h || i) return !0;
    var j = a - c, k = b - d, l = this.sqrt(j * j + k * k),
        m = ((e - a) * (c - a) + (f - b) * (d - b)) / this.pow(l, 2), n = a + m * (c - a), o = b + m * (d - b),
    ...
    if (k >= 0 && 1 >= k && l >= 0 && 1 >= l) {
        if (this._collideDebug || i) var m = a + k * (c - a), n = b + k * (d - b);
        return this._collideDebug && this.ellipse(m, n, 10, 10), i ? j = {x: m, y: n} : !0
    }
    return i ? j = {x: !1, y: !1} : !1
    ...
    for (var f = 0, g = 0; g < d.length; g++) {
        ...
        var h = d[g], i = d[f], j = this.collideLineCircle(h.x, h.y, i.x, i.y, a, b, c);
        if (j) return !0
    }
    if (1 == e) {
    ...
    for (var g = 0, h = 0; h < e.length; h++) {
        ...
        var i = e[h], j = e[g], k = this.collideLineRect(i.x, i.y, j.x, j.y, a, b, c, d);
        if (k) return !0;
        if (1 == f) {
    ...
    for (var f = 0, g = 0; g < e.length; g++) {
        ...
        var h = e[g].x, i = e[g].y, j = e[f].x, k = e[f].y, l = this.collideLineLine(a, b, c, d, h, i, j, k);
        if (l) return !0
    }
    return !1
    ...
    for (var d = 0, e = 0; e < a.length; e++) {
        ...
        var f = a[e], g = a[d], h = this.collideLinePoly(f.x, f.y, g.x, g.y, b);
        if (h) return !0;
        if (1 == c && (h = this.collidePointPoly(b[0].x, b[0].y, a))) return !0
    }
    return !1
}, p5.prototype.collidePointTriangle = function (a, b, c, d, e, f, g, h) {
    var i = this.abs((e - c) * (h - d) - (g - c) * (f - d)), j = this.abs((c - a) * (f - b) - (e - a) * (d - b)),
        k = this.abs((e - a) * (h - b) - (g - a) * (f - b)), l = this.abs((g - a) * (d - b) - (c - a) * (h - b));
    return j + k + l == i ? !0 : !1
    ...
    void 0 == h && (h = 0);
    var i = this.createVector(a, b), j = this.createVector(c, d), k = this.createVector(e, 0).rotate(f),
        l = i.copy().sub(j);
    if (i.dist(j) <= e + h) {
        var m = k.dot(l), n = k.angleBetween(l);
...
function Powerup() {
    this.size = 25;
    if (!img) {
        img = loadImage("/static/main/img/powerup.png");
    }
    this.x = random() * width;
